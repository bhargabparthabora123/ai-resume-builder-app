...
//         console.log("Education details saved successfully:", resp);
//     },
// (error)=>{
//         setLoading(false)
...
function Education() {
  ...
  return (
    ...
    <div className='flex justify-between'>
            <div className='flex gap-2'>
            <Button variant="outline" onClick={AddNewEducation} className="text-green-600"> + Add More Education</Button>
            <Button variant="outline" onClick={RemoveEducation} className="text-green-600"> - Remove</Button>
